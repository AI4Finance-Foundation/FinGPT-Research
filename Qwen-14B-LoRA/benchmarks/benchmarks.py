...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_model", required=True, type=str, choices=['chatglm2', 'llama2', 'llama2-13b', 'falcon', 'internlm', 'internlm-20b', 'qwen', 'mpt', 'mpt-30b', 'bloom', 'yi-34b'])
    parser.add_argument("--peft_model", required=True, type=str)
    parser.add_argument("--max_length", default=512, type=int)
    parser.add_argument("--batch_size", default=4, type=int, help="The train batch size per device")
    parser.add_argument("--instruct_template", default='default')
    parser.add_argument("--dtype", default="fp32", choices=["fp32", "fp16", "bf16"], type=str)
